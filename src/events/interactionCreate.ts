								...
								new StringSelectMenuBuilder()
									...
									.setOptions([
										...
										},
										{
											label: "Sexuality",
											description:
												"The role that best describes your sexuality.",
											value: "sexuality",
										},
										{
											label: "Pronouns",
            ...
            `);
					...
					if (stage === "removeRole") {
						...
						try {
							...
							if (
								["minor", "boomer"].includes(roleToRemove.name.toLowerCase())
							) {
								roleType = "age";
							} else if (
								[
            ...
            `);
                        ...
                        `,
							...
							if (
								...
								if (
									["minor", "boomer"].includes(
										rolesMarkedForAddition.first().name.toLowerCase()
									)
								) {
									roleType = "age";
								} else if (
									...
									colors.includes(rolesMarkedForAddition.first().name)
								) {
									roleType = "color";
								} else if (
									[
